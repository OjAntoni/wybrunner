...
export const CAMERA_POSITION_SMOOTHING = 0.065;
export const CAMERA_ZOOM_SMOOTHING = 0.016;
export const CAMERA_CHASE_ZOOM_MULT = 0.9;
export const CAMERA_CHASE_TRIGGER_RADIUS_TILES = 14;
export const CAMERA_CHASE_RELEASE_RADIUS_TILES = 18;
export const CAMERA_CHASE_EXIT_HOLD_MS = 900;
export const CAMERA_CHASE_BLEND_IN_SMOOTHING = 0.03;
export const CAMERA_CHASE_BLEND_OUT_SMOOTHING = 0.012;
export const CAMERA_CHASE_HEARTBEAT_BPM = 78;
export const CAMERA_CHASE_HEARTBEAT_ZOOM_AMPLITUDE = 0.042;
