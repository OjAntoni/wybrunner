  ...
  return (
    <>
      ...
      <div className="inventory-group">
        ...
        <div className="inventory-slots" data-item-type="spikes" data-count={spikesLeft}>
          {[0, 1, 2].map((i) => (
            <div
              key={`spike-${i}`}
              className="inventory-slot"
              data-item-type="spike"
              data-index={i}
              data-filled={i < spikesLeft}
            >
              ...
              {i === 0 && <CoinCostBadge amount={SPIKE_PURCHASE_COINS} />}
            </div>
          ))}
        </div>
      ...
      <div className="inventory-group">
        ...
        <div className="inventory-slots" data-item-type="bombs" data-count={bombsLeft}>
          {[0, 1, 2].map((i) => (
            <div
              key={`bomb-${i}`}
              className="inventory-slot"
            ...
            >
              ...
              {i === 0 && <CoinCostBadge amount={BOMB_PURCHASE_COINS} />}
            </div>
          ))}
        </div>
...
export const InventoryPanel = memo(InventoryPanelComponent, (prev, next) => {
  ...
  return (
    ...
    // Counts are updated via DOM, not React
  );
});
